 ...
 */
@WebServlet("/student/studnetcount.do")
public class StudentSelectCountServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int sutdentCount = new StudentService().selectStudentCount();
		System.out.println(sutdentCount);
		request.setAttribute("studentCount", sutdentCount);
